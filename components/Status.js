...
export default function Status() {
  ...
  return (
    <div className="mt-6]">
      <div
        className="relative w-full  overflow-auto bg-cover bg-center  py-20 lg:py-32 "
        style={{
      ...
      >
        ...
        <div className="px-4 lg:px-0 lg:w-11/12   mx-auto  relative opacity-100 z-20 ">
        <h5 className="text-2xl md:text-4xl font-semibold text-white text-center shadow shadow-gray-200 rounded-full w-fit mx-auto p-2 md:p-4 px-3 lg:px-6">Bolster Impact: Dreams to Destinations</h5>
          <div className="grid sm:grid-cols-2 lg:grid-cols-6 mt-10 md:mt-16 lg:gap-0 gap-10">
            {numbers.map((number) => (
                <div key={number.item} className="text-white z-50 text-center borde">
                      <VisibilitySensor 
                    scrollCheck={true}
                  ...
                  <h3 className="text-4xl md:text-5xl font-semibold">
                    ...
                    <p className="md:text-xl mt-2 whitespace-pre-line">{number.item }</p>
        ...
        >
          {logos.map((logo) => (
         <div key={logo.src}  className="bg-white h-24 flex justify-center items-center m-1 md:m-2 rounded-md">
         <div className="">

...
export default function We() {
  ...
  const team = [
    ...
    },
    {
      ...
      bio: "Muhammad Shafeeq is a commerce graduate from Jamia Millia Islamia with a deep passion for innovation in schooling and educational management. With a keen eye for organizational efficiency and program development, he plays a key role in shaping Bolster Foundation’s initiatives.  As the Head of Administration & Programs, Shafeeq oversees the strategic planning, execution, and management of Bolster’s various educational programs. His leadership ensures that Bolster’s initiatives run smoothly, efficiently, and effectively, creating meaningful impact in the field of education.",
    },
    {
      name: "Vajid",
      position: "Azim Premji University",
